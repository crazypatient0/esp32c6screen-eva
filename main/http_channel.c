...
".content {padding:20px;max-width:900px;flex:1;min-height:0;overflow-y:auto}"
".card {background:#161b22;border:1px solid #30363d;border-radius:8px;padding:16px;margin-bottom:16px;display:flex;flex-direction:column}"
".card h3 {color:#f0f6fc;font-size:14px;margin-bottom:12px;font-weight:600}"
".card .chat-messages {flex:1;min-height:0;overflow-y:auto}"
...
".chat-messages {min-height:200px;flex:1;overflow-y:auto;border:1px solid #30363d;border-radius:6px;padding:12px;margin-bottom:12px;background:#0d1117}"
